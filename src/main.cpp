...
int main()
{
    const char* output_path = "/Users/seonghwanjun/Dropbox/Research/single-cell-research/repos/linear-progression/data/raphael/25genes/error0.01/rep0/pg/";
    const char* input_path = "/Users/seonghwanjun/Dropbox/Research/single-cell-research/repos/linear-progression/data/raphael/25genes/error0.01/rep0/matrix.csv";
