...
double compute_likelihood_for_sample(const vector<size_t> &r, vector<size_t> &pathway_sizes, size_t stage, double bgp, double fbp);
...
double compute_pathway_likelihood(gsl_matrix &obs, vector<size_t> &sum_vec, const LinearProgressionState &state, const LinearProgressionParameters &params, bool use_cache);
double compute_pathway_likelihood(gsl_matrix &obs, vector<size_t> &sum_vec, const LinearProgressionState &state, const LinearProgressionParameters &params);
